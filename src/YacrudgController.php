...
class YacrudgController extends Controller
{
    ...
    public function info($controller){
        ...
        $response = app('App\Http\Controllers\Yacrudg\\'.$convertedName.'Controller')->index();
    ...
    {
        $convertedName = Str::studly(Str::singular($controller));
        app('App\Http\Controllers\Yacrudg\\'.$convertedName.'Controller')->destroy($id);
    ...
    public function updateData($controller, $id)
    {
        $tablenames = $this->getTableNames();
        $convertedName = Str::studly(Str::singular($controller));
        $response = app('App\Http\Controllers\Yacrudg\\'.$convertedName.'Controller')->show($request, $id);
    ...
    {
        $convertedName = Str::studly(Str::singular($controller));
        $info = app('App\Http\Controllers\Yacrudg\\'.$convertedName.'Controller')->update($request, $id);
        return redirect(route('yacrudgTable', ['controller' => $controller]));
    }
    ...
    {
        $convertedName = Str::studly(Str::singular($controller));
        $newrow = app('App\Http\Controllers\Yacrudg\\'.$convertedName.'Controller')->store($request);
        return redirect(route('yacrudgTable', ['controller' => $controller]));
    }
